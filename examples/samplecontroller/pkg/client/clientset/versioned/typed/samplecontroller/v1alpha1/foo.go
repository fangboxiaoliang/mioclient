...
import (
	v1alpha1 "hidevops.io/mioclient/examples/samplecontroller/pkg/apis/samplecontroller/v1alpha1"
	scheme "hidevops.io/mioclient/examples/samplecontroller/pkg/client/clientset/versioned/scheme"
