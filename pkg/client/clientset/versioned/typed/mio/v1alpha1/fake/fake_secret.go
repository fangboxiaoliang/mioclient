...
var secretsResource = schema.GroupVersionResource{Group: "mio.io", Version: "v1alpha1", Resource: "secrets"}

var secretsKind = schema.GroupVersionKind{Group: "mio.io", Version: "v1alpha1", Kind: "Secret"}
