...
var pipelinesResource = schema.GroupVersionResource{Group: "mio.k8s.io", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "mio.k8s.io", Version: "v1alpha1", Kind: "Pipeline"}
