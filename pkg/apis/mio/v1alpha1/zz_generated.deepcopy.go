...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BuildCommand) DeepCopyInto(out *BuildCommand) {
	*out = *in
	if in.Params != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BuildCommand.
func (in *BuildCommand) DeepCopy() *BuildCommand {
	if in == nil {
		return nil
	}
	out := new(BuildCommand)
	in.DeepCopyInto(out)
	return out
}
